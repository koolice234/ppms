...
if(isset($_POST['hemaAdd'])){
	...
	if($checkrows>0) {
		...
		$stmt1 = $connect->prepare("INSERT INTO hematology (sched_ID,patient_ID,hema_date,hema_hemoglobin,hema_hematocrit,hema_rbcCount,hema_wbcCount,hema_plateletCount,hema_neutropils,hema_eosinophils,hema_basophils,hema_totalDiffCount,hema_monocytes) VALUES ('$schedID','$H_id','$H_date','$H_hemoglobin','$H_hematocrit','$H_rbc','$H_wbc','$H_platelet','$H_neutropil','$H_eosinophils','$H_basophils','$H_diffCount','$H_monocytes')");
		$stmt2 = $connect->prepare("INSERT INTO transaction(trans_type,trans_date,trans_patientid) VALUES ('Hematology','$H_date','$H_id')");
		$stmt2->execute();
		$stmt1->execute();
