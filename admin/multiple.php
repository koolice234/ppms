        ...
        <script>
            $(document).ready(function(){
                $("#pyear").on('change', function(){
                    var year=$(this).val();
                    window.location = 'multiple.php?year='+year;
                });
            });
        </script>
    </body>
